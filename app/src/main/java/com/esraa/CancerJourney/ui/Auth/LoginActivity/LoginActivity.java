...
import com.esraa.CancerJourney.ui.Auth.ForgotPasswordActivity;
import com.esraa.CancerJourney.ui.Auth.Registration.RegistrationActivity;
import com.esraa.CancerJourney.ui.Welcome.WelcomeActivity;
...
public class LoginActivity extends AppCompatActivity implements Contract.View , View.OnClickListener{
    ...
    protected void onStart() {
        super.onStart();
        if(mAuth.getCurrentUser()!=null &&  SharedPref.getLoginUserData(LoginActivity.this)!=null) {
            openHomeActivity();
        }
    }
